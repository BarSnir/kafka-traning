...
public class SpecificSchemaRecord {
    public static void main( String[] args )
    {
        Customer.Builder customerBuilder = Customer.newBuilder();
        customerBuilder.setAge(25);
        customerBuilder.setFirstName("Bar");
        customerBuilder.setLastName("Snir");
        customerBuilder.setAutomatedEmail(false);
        customerBuilder.setHeight(1.7f);
        customerBuilder.setWeight(70);
